...
const caargarProoduct = () => {
    return JSON.parse(localStorage.getItem("producto"));
}

const reenderProoduct = () =>{
    const product = caargarProoduct();
    salida =`
        ...
        <div class="w-50 d-flex flex-column justify-content-center alaing-items-center p-2  shadow-lg">
            ...
            <div>
                <div class="d-flex justify-content-between aling-items-end border-bottom border-info">
                    <p class="mb-0"><b> Capacidad</b></p>
                    <p class="mb-0"> ${product.capacidad} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0 "><b> Velocidad </b></p>
                    <p class="mb-0"> ${product.velocidad} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                ...
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Cantidad de memorias </b></p>
                    <p class="mb-0"> ${product.cantidad} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Latencia </b></p>
                    <p class="mb-0"> ${product.latencia} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Voltaje</b></p>
                    <p class="mb-0"> ${product.voltaje} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Disipador</b></p>
                    <p class="mb-0"> ${product.disparador} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Disipador Alto</b></p>
                    <p class="mb-0"> ${product.disparadoral} </p>
                </div>
            </div>
        </div>
        `;
