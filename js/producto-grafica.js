...
const caargarProduct = () => {
    return JSON.parse(localStorage.getItem("producto"));
}

const reenderProduct = () =>{
    const product = caargarProduct();
    salida =`
        ...
        <div class="w-50 d-flex flex-column justify-content-center alaing-items-center p-2  shadow-lg">
            ...
            <div>
                ...
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0 "><b> Chipset Gpu</b></p>
                    <p class="mb-0"> ${product.chipset} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Entrada Video </b></p>
                    <p class="mb-0"> ${product.entrada} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b>Caracteristicas especiales</b></p>
                    <p class="mb-0"> ${product.caracteristicas} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Vga </b></p>
                    <p class="mb-0"> ${product.vga} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Hdmi </b></p>
                    <p class="mb-0"> ${product.hdmi} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> displayports </b></p>
                    <p class="mb-0"> ${product.displayports} </p>
                </div>
            </div>
        </div>
        `;
