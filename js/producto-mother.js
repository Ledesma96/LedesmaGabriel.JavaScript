...
const caargarProductMother = () => {
    return JSON.parse(localStorage.getItem("producto"));
}

const reenderProductMother = () =>{
    const product = caargarProductMother();
    salida =`
...
const reenderDescrProductMother = () =>{
    const product = caargarProductMother();
    salida =`
        <div class="w-50 d-flex flex-column justify-content-center alaing-items-center p-2  shadow-lg">
            ...
            <div>
                <div class="d-flex justify-content-between aling-items-end border-bottom border-info">
                    <p class="mb-0"><b> Cantidad De Slot Pci-e 16X</b></p>
                    <p class="mb-0"> ${product.slotPcie16X} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0 "><b>Cantidad De Slot Pci-e 1X</b></p>
                    <p class="mb-0"> ${product.slotPcie1X} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Tecnología Multi Gpu </b></p>
                    <p class="mb-0"> ${product.tecnología} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Puertos Sata </b></p>
                    <p class="mb-0"> ${product.puertos} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Salidas Vga </b></p>
                    <p class="mb-0"> ${product.vga} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b>Salidas Hdmi</b></p>
                    <p class="mb-0"> ${product.hdmi} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Tipo De Memoria</b></p>
                    <p class="mb-0"> ${product.memoria} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Cantidad De Slot De Memorias </b></p>
                    <p class="mb-0"> ${product.cantidadMemorias} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Placa Wifi Integrada</b></p>
                    <p class="mb-0"> ${product.placaWifi} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b>Placa De Red</b></p>
                    <p class="mb-0"> ${product.placaDeRed} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Puertos Usb 2.0 Traseros </b></p>
                    <p class="mb-0"> ${product.usb20} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Puertos Usb 3.0 Traseros </b></p>
                    <p class="mb-0"> ${product.usb30} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Puertos Usb 3.1 Traseros </b></p>
                    <p class="mb-0"> ${product.usb31} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Puertos Usb 3.2 Traseros </b></p>
                    <p class="mb-0"> ${product.usb32} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Puertos Usb Type-c</b></p>
                    <p class="mb-0"> ${product.usbC} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Watts Máximos Para Cpus </b></p>
                    <p class="mb-0"> ${product.watts} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Consumo </b></p>
                    <p class="mb-0"> ${product.consumo} </p>
                </div>
            </div>
        </div>
        `;
...
botonCarrito();
reenderProductMother();
reenderDescrProductMother();