        ...
        <div class="w-50 d-flex flex-column justify-content-center alaing-items-center p-2  shadow-lg">
            ...
            <div>
                <div class="d-flex justify-content-between aling-items-end border-bottom border-info">
                    <p class="mb-0"><b> Modelo </b></p>
                    <p class="mb-0"> ${product.modelo} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0 "><b> Socket </b></p>
                    <p class="mb-0"> ${product.socket} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Nucleos </b></p>
                    <p class="mb-0"> ${product.nucleos} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Frecuencia </b></p>
                    <p class="mb-0"> ${product.frecuencia} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> GPU </b></p>
                    <p class="mb-0"> ${product.GPU} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Hilos </b></p>
                    <p class="mb-0"> ${product.hilos} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Frecuencia turbo </b></p>
                    <p class="mb-0"> ${product.frecuenciaTurbo} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Familia </b></p>
                    <p class="mb-0"> ${product.familia} </p>
                </div>
            </div>
        </div>
        `;
