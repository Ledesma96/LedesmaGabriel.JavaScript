...
const caargarProductGabinete = () => {
    return JSON.parse(localStorage.getItem("producto"));
}

const reenderProductGabinete = () =>{
    const product = caargarProductGabinete();
    salida =`
...
const reenderDescrProductGabinete = () =>{
    const product = caargarProductGabinete();
    salida =`
        <div class="w-50 d-flex flex-column justify-content-center alaing-items-center p-2  shadow-lg">
            <h5 class="scrollNone mb-2 text-center border-bottom border-info pb-2">CARACTERISTICAS GENERALES</h5>
            <div>
                <div class="d-flex justify-content-between aling-items-end border-bottom border-info ">
                    <p class="mb-0"><b> Factor Mother </b></p>
                    <p class="mb-0"> ${product.factor} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0 "><b> Fuente En Posición Superior </b></p>
                    <p class="mb-0"> ${product.fuente} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2 ">
                    <p class="mb-0"><b> Con Ventana </b></p>
                    <p class="mb-0"> ${product.ventana} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Tipo De Ventana </b></p>
                    <p class="mb-0"> ${product.tipoVentana} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Colores </b></p>
                    <p class="mb-0"> ${product.color} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Alto </b></p>
                    <p class="mb-0"> ${product.alto} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Ancho </b></p>
                    <p class="mb-0"> ${product.ancho} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Profundidad </b></p>
                    <p class="mb-0"> ${product.profundidad} </p>
                </div>
                <div class="d-flex justify-content-between align-items-end border-bottom border-info mt-2">
                    <p class="mb-0"><b> Tipo De Fuente Admitida
                    </b></p>
                    <p class="mb-0"> ${product.tipoFuente} </p>
                </div>
            </div>
        </div>
        `;
...
botonCarrito();
reenderProductGabinete();
reenderDescrProductGabinete();